...
/**
 * The ChaosGameDescriptionFactory class is used to create ChaosGameDescription objects for
 * different fractals.
 *
...
public class ChaosGameDescriptionFactory {
  ...
  /**
   * Creates a ChaosGameDescription object for the Sierpinski triangle. The Sierpinski triangle is
   * created by three affine transformations.
   *
  ...
  /**
   * Creates a ChaosGameDescription object for the Barnsley fern. The Barnsley fern is created by
  ...
  public ChaosGameDescription barnsley(Vector2D minCoordsVector, Vector2D maxCoordsVector) {
    ...
    List<Transform2D> affineTransforms = createAffineTransforms(
        new Matrix2x2[]{transformationMatrix1, transformationMatrix2, transformationMatrix3,
            transformationMatrix4},
        new Vector2D[]{transformationVector1, transformationVector2, transformationVector2,
  ...
  /**
   * Creates a ChaosGameDescription object for the maple tree. The maple tree is created by four
  ...
  /**
   * Creates a ChaosGameDescription object for the Julia set. The Julia set is created by two Julia
   * transformations.
   *
   * @param minCoordsVector the minimum coordinates of the canvas
   * @param maxCoordsVector the maximum coordinates of the canvas
  ...
  /**
   * Creates a ChaosGameDescription object for affine transformations. The affine transformations
   * are created by a list of matrices and a list of vectors.
   *
  ...
  public ChaosGameDescription affine(List<Matrix2x2> matrices, List<Vector2D> vectors,
      Vector2D minCoordsVector, Vector2D maxCoordsVector) {
